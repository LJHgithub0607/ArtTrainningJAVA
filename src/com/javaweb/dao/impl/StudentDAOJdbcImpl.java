...
public class StudentDAOJdbcImpl extends DAO<Student> implements StudentDAO{
	...
	public void updatenew(Student student) {
		...
		update(sql, student.getT_Student_User_Name(),student.getT_Student_User_Password(),student.getT_Student_RealName(),student.getT_Student_Phone_Number(),student.getT_Student_Assessment(),student.getT_Student_Email(),student.getT_Student_Authority(),student.getT_Student_ID());
		
	}

	@Override
	public void save(Student student) {
		String sql="INSERT INTO t_Student(t_Student_User_Name,t_Student_User_Password,t_Student_Realname,t_Student_Phone_Number,t_Student_Email) VALUES(?,?,?,?,?)";
		update(sql, student.getT_Student_User_Name(),student.getT_Student_User_Password(),student.getT_Student_RealName(),student.getT_Student_Phone_Number(),student.getT_Student_Email());
	}
