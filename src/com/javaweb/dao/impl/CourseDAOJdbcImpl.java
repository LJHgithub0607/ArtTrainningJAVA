...
public class CourseDAOJdbcImpl extends DAO<Course> implements CourseDAO {
	...
	public void updatenew(Course course) {
		String sql="update t_Course SET t_Course_theCourse_ID=?,t_Couser_Student_ID=?,t_Course_Total_Time=?,t_Course_DateOfLeave=? WHERE t_Course_ID=?";
		update(sql, course.getT_Course_theCourse_ID(),course.getT_Couser_Student_ID(),course.getT_Course_Total_Time(),course.getT_Course_DateOfLeave(),course.getT_Course_ID());
